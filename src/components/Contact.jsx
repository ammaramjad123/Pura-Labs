...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-slate-50 via-white to-purple-50 mt-22">
     ...
     <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-27 sm:pt-32 pb-20 text-center">
  ...
  <span className="text-sm font-semibold text-purple-600">
    Get in Touch
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-0 sm:-mt-16 pb-16">
        {/* Main Contact Card */}
